...
const Services = () => {
  const services = [// ... keep existing code (services array definition)
  {
                ...
                <div className="relative h-80 w-full overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-black/60 flex flex-col justify-between p-4">
                    ...
                    <div className="text-center">
                      ...
                      <Button variant="outline" size="sm" className="w-full border-barbershop-gold bg-barbershop-gold/20 text-barbershop-gold hover:bg-barbershop-gold hover:text-black backdrop-blur-sm font-bold" style={{
